...
*Fleet standards: `5qtb5t9v5k-rgb/motherboard` (`add_repo`). This repo is the
source for two of them — `agentti-arkkitehtuuri.md` §2 (the five-layer model,
referenced rather than copied) and `agentti-kaytannot.md` §4 (the eval harness
pattern).*
